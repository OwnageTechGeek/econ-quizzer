...
class Quizzer(object):
   ...
   def runMenu(self):
      ...
      number = raw_input("How many questions would you like? 1-" + str(len(self.questions)) + "> ")
      number = number.strip()
      ...
      if number == "0":
         self.runMenu()
      elif int(number) > len(self.questions):
         print "We don't have " + str(number) + " questions, but here's " + str(len(self.questions)) + "."
...
def main():
   ...
   print("Would you like to use questions from: ")
   print("1. first midterm")
   print("2. second midterm")
   print("3. final exam")
   choice = raw_input("> ")
   choice = choice.strip()
   if choice == "1": quizzer = Quizzer("midterm1MC.txt")
   elif choice == "2": quizzer = Quizzer("midterm2MC.txt")
   elif choice == "3": quizzer = Quizzer("finalMC.txt")
   else:
